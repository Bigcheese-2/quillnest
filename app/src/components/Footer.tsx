...
export default function Footer() {
  ...
  return (
    <footer
      className="footer-main text-white dark:text-foreground w-full flex flex-col gap-20 md:pt-28 pb-16 md:px-8  lg:px-20 mt-10"
    >
      <div className=" mx-auto w-full lg:w-5/6 flex flex-col md:flex-row justify-between gap-10 ">
        {/* Menu Links */}
        <div className="footer-section footer-col-blue flex-1 text-white py-8 text-center md:text-left w-full">
        ...
        {/* Our Services */}
        <div className="footer-section footer-col-white services-section flex-1 text-center md:text-left py-8">
      ...
      <div className="text-[#ffff] flex justify-center items-center">
      © 2025 Quill Nest
      </div>
    </footer>
  );
